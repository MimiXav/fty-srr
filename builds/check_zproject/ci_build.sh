...
git clone --quiet --depth 1 -b master https://github.com/42ity/libsodium.git libsodium
git clone --quiet --depth 1 -b master https://github.com/42ity/libzmq.git libzmq
git clone --quiet --depth 1 -b master https://github.com/42ity/czmq.git czmq
git clone --quiet --depth 1 -b master https://github.com/42ity/malamute.git malamute
